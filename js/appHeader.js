...
export const createHeader = (city) => {
    ...
    headerContainer.classList.add('container', 'header_container');
    headerCity.classList.add('header_city');
    headerUnits.classList.add('header_units');
    cityChange.classList.add('city_change', 'btn-reset');
    cityLocation.classList.add('city_location', 'btn-reset')
    cityName.classList.add('city_name');
    cityInner.classList.add('city_inner');
    unitsC.classList.add('units_c', 'btn-reset', 'unit-current');
    unitsF.classList.add('units_f', 'btn-reset');
    ...
    cityChange.textContent = 'Change Location';
    ...
    unitsC.addEventListener('click', () => {
        ...
        document.querySelector('.weather_units').textContent = 'o';
    ...
    unitsF.addEventListener('click', () => {
        ...
        document.querySelector('.weather_units').textContent = 'f';
